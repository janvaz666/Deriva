...
{
    public static class QueryFormacion
    {
        #region metodos          
        ///// <summary>          
        ...
        {
            var qry = new StringBuilder();
            qry.Append("select top 1 idformacionUsuario from formacionUsuario order by idformacionUsuario desc");
            return qry.ToString();
        }
        /// <summary>          
        ...
        public static string Add(FormacionUsuarioEntity entity)
        {
            var qry = new StringBuilder();
            DateTime myDateTime = DateTime.Now;
            string sqlFormattedDate = myDateTime.ToString("yyyy-MM-dd HH:mm:ss.fff");
            qry.Append("insert into formacionUsuario (Usuario_idUsuario, carrera, institucion, nivel)");
            qry.AppendFormat(" values({0}, '{1}', '{2}', '{3}')",

...
{
    public static class QueryHorario
    {
        #region metodos          
        ///// <summary>          
        ...
        public static string Add(HorarioUsuarioEntity entity)
        {
            var qry = new StringBuilder();
            DateTime myDateTime = DateTime.Now;
            string sqlFormattedDate = myDateTime.ToString("yyyy-MM-dd HH:mm:ss.fff");
            qry.Append("insert into horarioUsuario (Usuario_idUsuario, horario, dia)");

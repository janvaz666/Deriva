...
{
    public static class QueryEspecialidadUsuario
    {
        #region metodos          
        ///// <summary>          
        ...
        {
            var qry = new StringBuilder();
            qry.Append("select top 1 idEspecialidadUsuario from especialidadUsuario order by idEspecialidadUsuario desc");
            return qry.ToString();
        }
        /// <summary>          
        ...
        public static string Add(EspecialidadUsuarioEntity entity)
        {
            var qry = new StringBuilder();
            DateTime myDateTime = DateTime.Now;
            string sqlFormattedDate = myDateTime.ToString("yyyy-MM-dd HH:mm:ss.fff");
            qry.Append("insert into especialidadUsuario (Usuario_idUsuario, especialidad_idespecialidad)");
            qry.AppendFormat(" values({0}, {1})",
                entity.Usuario_idUsuario,
                entity.Especialidad_idespecialidad
                );
            return qry.ToString();
        }
        ///// <summary>         

...
namespace infrastructure.data
{
    public class ConvenioRepository : IConvenioRepository
    {
        ...
        #endregion
        #region constructor            
        public ConvenioRepository(ConnectionString connectionString)
        {
        ...
        async Task<IEnumerable<ConvenioEntity>> IConvenioRepository.GetConvenio()
            {
            var query = QueryConvenio.GetConvenio();
            using var conn = new SqlConnection(connectionString.Value);
            var result = await conn.QueryAsync<ConvenioEntity>(query);
            return result;
        }
        ///// <summary>    
        ///// Editar UnidadMedida       
